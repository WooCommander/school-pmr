...
export const schools: SchoolItem[] = [
  {
    ...
    heroText:
      'Качественное образование, развитие личности и подготовка к жизни в современном обществе с 1962 года.',
    stats: [
  ...
  },
  {
    ...
    heroText:
      'Школа с устойчивой академической базой, активной внеурочной жизнью и современной школьной средой.',
    stats: [
  ...
  },
  {
    ...
    heroTitle: 'Тираспольская\nсредняя школа №3',
    heroText:
      'Публичный сайт школы с единым доступом к новостям, расписанию, документам и контактам.',
    stats: [
  ...
  },
  {
    ...
    heroTitle: 'Тираспольская\nсредняя школа №4',
    heroText:
      'Современный школьный сайт с единым интерфейсом и возможностью развивать публичную часть каждой школы отдельно.',
    stats: [
  ...
  },
  {
    ...
    heroText:
      'Лицейская модель обучения с публичным сайтом в общей дизайн-системе.',
    stats: [
